...
export default function Home() {
  return (
    <div>
        <h1>Restaurant App Privacy Policy</h1>
        <p>This privacy policy will help you understand how Restaurant App uses and protects the data you provide to us when you visit and use Restaurant App.</p>
        ...
        <h4>When you visit the blog, we may collect the following data:</h4>
            <ul>
        ...
        <h4>We are collecting your data for several reasons:</h4>
            <ul>
        ...
        <p>Restaurant App is committed to securing your data and keeping it confidential. Restaurant App has done all in its power to prevent data theft, unauthorized access, and disclosure by implementing the latest technologies and software, which help us safeguard all the information we collect online.</p>
        ...
        <p>Our blog contains links that lead to other websites. If you click on these links Restaurant App is not held responsible for your data and privacy protection. Visiting those websites is not governed by this privacy policy agreement. Make sure to read the privacy policy documentation of the website you go to from our website.</p>
